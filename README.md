...
> 此次沙龙的主题是《小程序》，但除了小程序外，分享的主题涉及到"前端多端统一开发框架"和"小程序数据埋点分析"以及小程序服务端架构，主要都涉及到了小程序这块的应用开发。总结围绕个人觉得对本人用处比较大的或者对后续工作有关进行。
...
## 总结
个人角色小程序此次分享开拓了本人的思想，知道怎么去做一个更加健全，功能更易扩展的多小程序。
